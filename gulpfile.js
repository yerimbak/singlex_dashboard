...
gulp.task(
    'default',
    gulp.series('fileClean', 'fileInclude','fileMove', 'images', 'sass', 'js', 'jsMove', 'fonts', 'watch')
);

gulp.task(
    'build',
    gulp.series('fileClean', 'fileInclude','fileMove', 'images', 'sass', 'js', 'jsMove', 'fonts', 'removeMap')
);
